...
void ExporterGIF::start(Menu * menu, ExportInfo * info){
    sceneEditor * scene = menu->scene;
    ...
    GifWriter writer;
    GifBegin(&writer, info->name.c_str(), width, height, delay, 8, false);
